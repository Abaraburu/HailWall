...
/**
 * Client-side entrypoint for Minecraft 26.1.2. Answers the server's login query by
 * collecting every top-level installed mod (id + version), signing the list, and
 * sending it back.
 *
