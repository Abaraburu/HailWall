...
/**
 * Fabric server-side entrypoint for Minecraft 1.18.2. Same logic as the other Fabric
 * targets; 1.18.2 has no {@code Component.literal} (added in 1.19) so disconnect messages
 * use {@code new TextComponent(...)}, and no {@code ResourceLocation.fromNamespaceAndPath}.
 */
